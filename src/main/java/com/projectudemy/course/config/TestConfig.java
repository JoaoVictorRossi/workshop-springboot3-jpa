...
import com.projectudemy.course.entities.Payment;
...
import com.projectudemy.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2022-03-20T21:15:04Z"), o1);
		o1.setPayment(pay1);
